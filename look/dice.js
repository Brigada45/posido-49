...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-3c769a33');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-3c769a33');}
...
var brandEl=document.querySelector('.rl-brand-3c769a33');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
